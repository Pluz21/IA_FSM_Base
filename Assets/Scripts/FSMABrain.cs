...
public class FSMABrain : MonoBehaviour
{
    ...
    [SerializeField] PatrolComponent patrolling = null;
    ...
    public PatrolComponent Patrolling => patrolling;
    ...
    { 
        ...
        patrolling = GetComponent<PatrolComponent>();
        moving = GetComponent<MovementComponent>();
         ...
         idling.OnElapsed += () =>
         {
             ...
             patrolling.FindRandomPoint();
             
         };
        patrolling.OnPatrolReachedTarget += () =>
        {
            if (!patrolling.IsAtLocation) return;
            fsm.SetBool(FINDRANDOMPOINT_DONE, true);
            fsm.SetBool(IDLE_DONE, false);
            patrolling.FindRandomPoint(); 
        };
        lookingForEnemy.OnEnemyNotInRange += () =>
        {
        ...
        lookingForEnemy.OnEnemyInRange += () =>
        {
            ...
            fsm.SetBool(FINDRANDOMPOINT_DONE, false);
        };
        eating.OnSelect += (t) =>
        {
            moving.SetTarget(t);
